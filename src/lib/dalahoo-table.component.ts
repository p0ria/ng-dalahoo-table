...
@Component({
  selector: 'dalahoo-table',
  templateUrl: './dalahoo-table.component.html',
  styleUrls: ['./dalahoo-table.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DalahooTableComponent implements OnInit, AfterViewInit{
  ...
  @ContentChildren(DalahooTableHeaderCellComponent, {descendants: true}) headerCellComponents: QueryList<DalahooTableHeaderCellComponent>;
  @ContentChildren(DalahooTableRowCellComponent, {descendants: true, read: ElementRef}) rowCellElements: QueryList<ElementRef>;
  @ContentChildren(DalahooTableHeaderCellComponent, {descendants: true, read: ElementRef}) headerCellElements: QueryList<ElementRef>;
  @ContentChildren(DalahooTableHeaderCellFilterComponent, {descendants: true}) filterCellComponents: QueryList<DalahooTableHeaderCellFilterComponent>;
